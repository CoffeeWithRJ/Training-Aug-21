...
SELECT * FROM Employee1 
WHERE Salary>
(SELECT Salary FROM Employee1 WHERE First_name= 'ROY')
...
AS
SELECT E.FirstName+' '+ E.LastName AS names, D.DepartmentName, L.City
...
AS
SELECT E.FirstName+' '+ E.LastName AS names,E.HireDate,E.Salary,D.DepartmentName
FROM Departments D JOIN  Employees E ON D.ManagerID=E.EmployeeID
